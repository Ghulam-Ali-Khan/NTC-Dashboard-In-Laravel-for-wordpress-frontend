...
<div class="col-lg-12 col-sm-12 shadow" style="background: white;margin-bottom:30px;border-radius:10px;">
    <form action="{!! route('insertPolicy') !!}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group ">
          ...
          <input style="border:1px solid #0162e878; padding-left:20px;border-radius:5px;" type="text" name="fullname" class="form-control" placeholder="Enter Full Name">
        ...
        <div class="form-group mt-0">
            ...
            <input style="border:1px solid #0162e878; padding-left:20px;border-radius:5px;" type="text" name="username" class="form-control"  placeholder="Enter Username">
          </div>
          <div class="form-group mt-0">
          ...
          <div class="form-group mt-0">
            ...
            <input style="border:1px solid #0162e878; padding-left:20px;border-radius:5px;" type="email" name="password" class="form-control"  placeholder="Enter Password">
          </div>
...
<script>
 document.getElementById('southRegionChoices').style.display = 'none';
 document.getElementById('northRegionChoices').style.display = 'none';
 document.getElementById('centralRegionChoices').style.display = 'none';

function displaySouthRegion(){

    if(document.getElementById('southRegionChoices').style.display == 'none'){
      console.log('1234678');
      document.getElementById('southRegionChoices').style.display = 'block';
    }
    else{
      document.getElementById('southRegionChoices').style.display = 'none';
    }
...
function displayNorthRegion(){
  if(document.getElementById('northRegionChoices').style.display == 'none'){
      console.log('1234678');
      document.getElementById('northRegionChoices').style.display = 'block';
    }
    else{
      document.getElementById('northRegionChoices').style.display = 'none';
    }
}
function displayCentralRegion(){
  if(document.getElementById('centralRegionChoices').style.display == 'none'){
      console.log('1234678');
      document.getElementById('centralRegionChoices').style.display = 'block';
    }
    else{
      document.getElementById('centralRegionChoices').style.display = 'none';
    }
